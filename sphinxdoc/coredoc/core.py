...
class SaQC(FunctionsMixin):
    ...
    def flagChangePoints(self, field, stat_func, thresh_func, window, min_periods, closed, reduce_window, reduce_func, flag):
        """
    ...
    def assignChangePointCluster(self, field, stat_func, thresh_func, window, min_periods, closed, reduce_window, reduce_func, model_by_resids):
        """
    ...
    def flagDriftFromReference(self, field, freq, reference, thresh, metric, target, flag):
        """
    ...
    def flagRegimeAnomaly(self, field, cluster_field, spread, method, metric, frac, flag):
        """
    ...
    def transferFlags(self, field, target):
        """
    ...
    def flagMVScores(self, field, trafo, alpha, n, func, iter_start, partition, partition_min, partition_trafo, stray_range, drop_flagged, thresh, min_periods, flag):
        """
    ...
    def flagRaise(self, field, thresh, raise_window, freq, average_window, raise_factor, slope, weight, flag):
        """
    ...
    def flagCrossStatistics(self, field, thresh, method, flag):
        """
    ...
    def resample(self, field, freq, func, maxna, maxna_group, maxna_flags, maxna_group_flags, flag_func, freq_check):
        """
    ...
    def assignKNNScore(self, field, target, n, func, freq, min_periods, method, metric, p):
        """
    ...
    def plot(self, field, path, max_gap, stats, history, xscope, phaseplot, store_kwargs):
        """
