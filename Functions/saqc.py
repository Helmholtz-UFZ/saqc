...
def flagChangePoints(field, stat_func, thresh_func, window, min_periods, closed, reduce_window, reduce_func, flag):
    """
...
def assignChangePointCluster(field, stat_func, thresh_func, window, min_periods, closed, reduce_window, reduce_func, set_flags, model_by_resids, assign_cluster, flag):
    """
...
def fitPolynomial(field, window, order, set_flags, min_periods, return_residues, flag):
    """
...
def flagDriftFromNorm(field, fields, freq, spread, frac, metric, method, flag):
    """
...
def flagDriftFromReference(field, fields, freq, thresh, metric, flag):
    """
...
def correctDrift(field, maintenance_field, model, cal_range, set_flags, flag):
    """
...
def correctRegimeAnomaly(field, cluster_field, model, tolerance, epoch):
    """
...
def interpolateByRolling(field, window, func, center, min_periods, flag):
    """
...
def interpolateIndex(field, freq, method, order, limit, downgrade):
    """
...
def flagMVScores(field, fields, trafo, alpha, n, func, iter_start, partition, partition_min, partition_trafo, stray_range, drop_flagged, thresh, min_periods, flag):
    """
...
def flagCrossStatistic(field, fields, thresh, method, flag):
    """
...
def resample(field, freq, func, maxna, maxna_group, maxna_flags, maxna_group_flags, flag_func, freq_check):
    """
...
def reindexFlags(field, method, source, freq, drop):
    """
...
def calculatePolynomialResidues(field, window, order, set_flags, min_periods, flag):
    """
...
def roll(field, window, func, set_flags, min_periods, center, flag):
    """
...
def assignKNNScore(field, n, trafo, trafo_on_partition, func, target, freq, min_periods, method, metric, p, radius):
    """
...
def mask(field, mode, mask_field, start, end, closed):
    """
...
def plot(field, path, max_gap, stats, plot_kwargs, fig_kwargs, store_kwargs):
    """
